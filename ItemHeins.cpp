...
Key::Key(string _name, string _textAction, string _textPickup, bool _erased)
{
	name = _name;
	textAction = _textAction;
	textPickup = _textPickup;
...
void Key::initAllKey()
{
	allKey = {
		...
		Key("ржавый ключ",
			...
			"Вы находите уже 5 ключ!\nСколько их в доме?\nВы аккуратно вешаете ключ на пояс..", true),
